...
public class ConfigurationDialog extends JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1578579274460499830L;
	...
	private JPanel createGamePanel(final TableFrame table) {		
		...
		for (int i=0;i!=gameKinds.length;++i) {
			...
			buttons[i].setAction(new AbstractAction(gameKindNames[i]) {
				 ...
				 * 
				 */
				private static final long serialVersionUID = -6328647736480767963L;
		...
		for (final Player.Direction p : Player.Direction.values()) {
			...
			checkBoxes[p.ordinal()].setAction(new AbstractAction(p
				...
				/**
						 * 
						 */
						private static final long serialVersionUID = 1814359268855351805L;
	...
	private JPanel createStartPanel() {
		...
		button.setAction(new AbstractAction("Let's Play") {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -1351782103652312741L;
