...
public abstract class AbstractCardGame implements CardGame, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5120875518041967129L;
	...
	public CardGame clone() {
		...
		// deep clone.
		try {
			return (CardGame) deepClone(this);
		} catch(Exception e) {
	...
	/**
	   ...
	   * @param object - object being cloned
	   * @return a cloned object of the object parameter passed in this method
	   */
